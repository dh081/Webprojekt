...
<div class="divformm">
    <div class="divform">
    <h2 style="border-bottom: 1px solid #EEEEEE;">Registrierung</h2>
    <form class="form" action="registrierung.php" method="post">

        <input type="text" size="40" maxlength="250" name="lname" placeholder="Dein Name"><br><br>

        <input type="text" size="40" maxlength="250" name="username" placeholder="Login"><br><br>

        <input type="email" size="40" maxlength="250" name="email" placeholder="Deine E-Mail Adresse"><br><br>
        ...
        <input type="text" size="40" maxlength="250" name="anschrift" placeholder="Anschrift"><br><br>

        <input type="text" size="40" maxlength="250" name="plz" placeholder="PLZ"><br><br>
